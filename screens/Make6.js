...
class Make6 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      text: '',
  ...
  async saveTask() {
    ...
    try {
      ...
      // Save task for Pagina6
      const taskPagina6 = { text, description, page: 'Pagina6' };
      tasks.push(taskPagina6);
