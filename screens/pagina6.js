...
class Pagina6 extends React.Component {
  ...
  async loadData() {
    try {
      ...
      // Filter tasks specific to Pagina6
      const pagina6Tasks = tasks.filter(task => task.page === 'Pagina6');
      this.setState({ tasks: pagina6Tasks });
    } catch (error) {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.boxes}>
          ...
          <TouchableOpacity 
            style={styles.footer}
            onPress={() => this.handleBoxPress('Make6')}
          >  
