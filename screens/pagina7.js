...
class Pagina7 extends React.Component {
  ...
  async loadData() {
    try {
      ...
      // Filter tasks specific to Pagina7
      const pagina7Tasks = tasks.filter(task => task.page === 'Pagina7');
      this.setState({ tasks: pagina7Tasks });
    } catch (error) {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.boxes}>
          ...
          <TouchableOpacity 
            style={styles.footer}
            onPress={() => this.handleBoxPress('Make7')}
          >  
